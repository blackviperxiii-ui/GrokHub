...
pub fn slash_help() -> String {
    [
        ...
        "Host, hands, and connector work stay off the chat. Bubbles wrap inside the chat pane. Copy and Reply sit on visible messages.",
...
mod tests {
    ...
    fn cabin_slash() {
        ...
        assert!(slash_help().contains("wrap inside the chat pane"));
