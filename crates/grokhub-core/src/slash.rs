...
mod tests {
    ...
    fn cabin_slash() {
        ...
        assert!(slash_help().contains("click window <title> close"));
        assert!(slash_help().contains("desk: calibrated"));
