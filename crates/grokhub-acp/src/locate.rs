...
/// Grok Build 1.0.32 `--help` is byte-identical to 1.0.31 for these flags.
...
mod tests {
    ...
    fn single_turn_args_bind_resume_and_json() {
        ...
        // 1.0.32 --help: same headless surface as 1.0.31. Do not switch to
        ...
        assert!(
            ...
            "1.0.32 still accepts hidden --no-auto-update"
        );
    }
