...
**v1.1.23** — Grok-native agent control plane for **Arch Linux / CachyOS**.
...
|----------|------------|--------|
| **Linux** (this) | [Grok-Hub](https://github.com/blackviperxiii-ui/Grok-Hub) | **v1.1.23** |
...
Stable track for **Arch / CachyOS + system Electron** (**v1.1.23**). Windows parity: [Grok-Hub-Windows](https://github.com/blackviperxiii-ui/Grok-Hub-Windows).

**Install (user):** in-app update, or extract `grokhub-desktop-v1.1.23.tar.gz` to `~/.local/lib/grokhub`.
