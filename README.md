...
**v2.6.36** — Native Grok Build GUI. Overlay pulls GitHub.

| Platform | Repository | Latest |
|----------|------------|--------|
| **Linux** (this) | [GrokHub](https://github.com/blackviperxiii-ui/GrokHub) | **v2.6.36** |
