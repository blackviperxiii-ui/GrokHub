...
**v2.6.15** — Grok-native unsandboxed control plane. You sit down in the cabin. It already knows the night.

| Platform | Repository | Latest |
|----------|------------|--------|
| **Linux** (this) | [Grok-Hub](https://github.com/blackviperxiii-ui/Grok-Hub) | **v2.6.15** |
