...
**v2.8.0** — Grok Build **1.0.17**. History is `grok sessions` 1:1. Chat is this Linux desktop. MCP tools can ask for a form or URL. `/usage` includes persisted session spend.

| Platform | Repository | Latest |
|----------|------------|--------|
| **Linux** (this) | [GrokHub](https://github.com/blackviperxiii-ui/GrokHub) | **v2.8.0** |
